...
'/images/profile.webp';
  ...
  return (
    ...
    <section id="home" className="pt-16 pb-16 px-5  flex flex-col justify-center items-center text-center text-white bg-cover bg-center mt-20" style={{ backgroundImage: `url(${imageUrl})` }}>
      ...
      <h1 className="tex-xl md:text-2xl font-bold mb-4">Hi, I'm Aaryan Raj</h1>
            <h2 className=" text-2xl leading-9 md:text-6xl md:leading-16 font-bold mb-4 max-w-260">Building Fast, Beautiful, & Interactive User Interfaces</h2>
